...
base_dir = 'VOC2012_train/JPEGImages/'
lbldir='VOC2012_train/Annotations/'
print("lendo base de treino - " + strftime("%Y-%m-%d %H:%M:%S", gmtime()))
X,Y=readimage(base_dir,lbldir)


base_dir = 'VOC2012_test/JPEGImages/'
lbldir='VOC2012_test/Annotations/'
...
history =model.fit(X_train, Y_train, batch_size=100, epochs=20, validation_data=(X_test, Y_test),verbose=1,callbacks=[metrics_callback])
